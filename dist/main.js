(() => {
  ...
  var initialize_default = new initialize();
  ...
  var MainAllNavLinks = function(navLink) {
    ...
    initialize_default.ActivateNavLink();
    initialize_default.ResetSectionSpecial();
  ...
  var MainBackBtn = function() {
    ...
    DeactivateActivateSectionImage(components_default.currentViewName);
    components_default.dimmer.classList.remove("active");
  ...
  var MainOptsMenuBtn = function(clickedBtnContent) {
    components_default.optsMenu.classList.remove("active");
    if (GetCurrentViewName() !== clickedBtnContent) {
      SetCurrentViewName(clickedBtnContent);
      components_default.optsMenuBtn.textContent = GetCurrentViewName();
      SetCtrlBtnIndex("");
      DeactivateActivateSectionText();
      DeactivateActivateSectionImage();
      ResetSectionVideos();
      ActivateSectionVideo(GetCurrentViewName());
      PlaySectionVideo(GetCurrentViewName());
      components_default.ctrlBtnWrapperComponents.classList.remove("active");
    }
  };
  var MainComponentVidsViewsEnds = function() {
    DeactivateActivateSectionImage(
      components_default.currentViewName,
      ctrlBtnIndex
    );
    DeactivateActivateSectionText("main");
  ...
  var init = function() {
    initialize_default.AddHandlerAllCtrlBtnsMouseEnter(MainAllCtrlBtnsMouseEnter);
    initialize_default.AddHandlerAllCtrlBtnsMouseLeave(MainAllCtrlBtnsMouseLeave);
    initialize_default.AddHandlerAllNavLinks(MainAllNavLinks);
    ...
    components_default.AddHandlerOptsMenu(MainOptsMenuBtn);
